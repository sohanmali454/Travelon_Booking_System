...
import { createCityPickupDropLocationsTable } from "../city_pickup_drop_locations/model/city_pickup_drop_locations_Model.js";
...
const initializeMastersDB = async () => {
  try {
    ...
    await createCityPickupDropLocationsTable();
  } catch (error) {
